...
const Update = () => {
  ...
  let update = (e) => {
    ...
    if (
      ...
      axios
        .put(`http://localhost:3000/employees/${getobj.id}`, obj)
        .then((response) => {
        ...
        alert('Successfully updated your Detailes Please check with your Login')
      ...
      <div id={style.formbox}>
        ...
        <form action="">
          ...
          <div id={style.UploadIMage}>
            ...
            <br />
            <label htmlFor="UploadIMage">Update Your Image</label>
